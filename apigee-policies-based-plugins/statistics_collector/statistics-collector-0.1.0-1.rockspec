...
description = {
   summary = "A brief summary of the statistics-collector plugin.",
...
build = {
   type = "builtin",
   modules = {
      ["kong.plugins.statistics-collector.handler"] = "handler.lua",
      ["kong.plugins.statistics-collector.schema"] = "schema.lua",
   }
}