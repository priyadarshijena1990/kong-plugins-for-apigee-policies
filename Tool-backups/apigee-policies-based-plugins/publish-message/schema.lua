        ...
        fields = {
          ...
          },
          {
            on_error_status = {
              ...
              default = 500,
              between = { 400, 599 },
              description = "The HTTP status code to return to the client if message publishing fails and `on_error_continue` is `false`.",
            },
          },
          {
            on_error_body = {
              ...
              description = "The response body to return to the client if message publishing fails and `on_error_continue` is `false`.",
            },
          },
          {
            on_error_continue = {
              type = "boolean",
              default = false,
              description = "If `true`, request processing will continue even if message publishing fails. If `false`, the request will be terminated.",
            },
          },
        },
      },
